...
export const averageMonthlySpend = () => [
    ...
    {
      $group: {
        _id: { year: { $year: "$datePurchased" }, month: { $month: "$datePurchased" } },
...
export const averageDailySpend = () => [
    ...
    {
      $group: {
        _id: { day: { $dayOfYear: "$datePurchased" }, year: { $year: "$datePurchased" } },
        totalSpend: { $sum: "$price" },
      },
    },
    {
...
export const bestDay = () => [
    {
      ...
      {
        $group: {
          _id: { date: { $dateToString: { format: "%Y-%m-%d", date: "$datePurchased" } } },
          totalSpend: { $sum: "$price" },
        },
      },
      {
